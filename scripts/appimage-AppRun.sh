...
export PYTHONPATH=${APPDIR}/usr/lib64/python3.12/site-packages
export PYTHONPATH=$PYTHONPATH:${APPDIR}/usr/lib64/python3.12
export PYTHONPATH=$PYTHONPATH:${APPDIR}/usr/lib64/python3.12/plat-linux2
export PYTHONPATH=$PYTHONPATH:${APPDIR}/usr/lib64/python3.12/lib-dynload
export SCC_SHARED=${APPDIR}/usr/share/scc
export PYTHON=${APPDIR}/usr/bin/python3.12
